...
export default ({ id }, t) => {
    const { hasImage, isWideImage, techs: projectTech, links } = projects.find(
    ...
    return /*html*/ `
        <div class="project">
            ${
                hasImage
                    ? `<img src="/images/projects/${id}.webp"
                            onerror="this.onerror=null;this.src='/images/projects/${id}.png';"
                            alt="${t[id].name}"
                            class="project__image ${isWideImage ? 'project__image--wide' : 'project__image--normal'}">`
                    : ""
            }           
